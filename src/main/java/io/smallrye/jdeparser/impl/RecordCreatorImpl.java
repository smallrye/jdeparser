...
public final class RecordCreatorImpl extends AbstractCreator implements RecordCreator, Writable {
    ...
    /** {@inheritDoc} */
    @Override
    public void component(final String name, final Type type) {
        checkActive();
        Assert.checkNotNullParam("name", name);
        Assert.checkNotEmptyParam("name", name);
    ...
    /** {@inheritDoc} */
    @Override
    public void component(final String name, final Type type, final Consumer<RecordComponentCreator> builder) {
        checkActive();
        Assert.checkNotNullParam("name", name);
        Assert.checkNotEmptyParam("name", name);
        Assert.checkNotNullParam("type", type);
    ...
    private void writeComponents(final SourceFileWriter writer) throws IOException {
        ...
        if (components.isEmpty()) {
            ...
            AbstractExpr.writeList(writer, components, FormatPreferences.Space.AFTER_COMMA_RECORD_COMPONENT,
