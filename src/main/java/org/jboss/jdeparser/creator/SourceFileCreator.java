...
import org.jboss.jdeparser.impl.SourceFileCreatorImpl;
 ...
 * {@link JSources#createSourceFile JSources.createSourceFile()}.
 */
public sealed interface SourceFileCreator permits SourceFileCreatorImpl {
     ...
     */
    void importStatic(JType type, String member);
